...
public class PatchCurriculumVitaeTests : IClassFixture<AuthorizedApiDockerStartupFactory>, IAsyncLifetime
{
    ...
    public PatchCurriculumVitaeTests(AuthorizedApiDockerStartupFactory factory)
    {
        _factory = factory;
